      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div className="space-y-6 rounded-2xl border border-raven-border/70 bg-raven-card/70 p-6">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-300">Book a DevOps Discovery Call directly from your browser.</p>
          </div>
          <div className="rounded-xl border border-raven-border/60 bg-raven-surface/60 p-4">
            <iframe
              title="Calendly scheduling"
              src="https://calendly.com/ravdevops/consult"
